...
namespace AdventureProject.Data.Migrations
{
    ...
    [Migration("20220424015849_playerUpdate")]
            ...
            modelBuilder.Entity("AdventureProject.Models.DataModels.PlayerCharacter", b =>
                {
                    ...
                    b.Property<int?>("CurrentLocationIDLocationID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CurrentLocationIDLocationID");
            ...
            modelBuilder.Entity("AdventureProject.Models.DataModels.PlayerCharacter", b =>
                {
                    ...
                    b.HasOne("AdventureProject.Models.DataModels.Location", "CurrentLocationID")
                        .WithMany()
                        .HasForeignKey("CurrentLocationIDLocationID");
                    ...
                    b.Navigation("CurrentLocationID");
